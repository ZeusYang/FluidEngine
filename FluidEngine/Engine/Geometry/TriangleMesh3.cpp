...
namespace Engine
{
	...
	Vector3D& TriangleMesh3::point(size_t i) { invalidateCache(); return _points[i]; }
	...
	void TriangleMesh3::invalidateCache() { _bvhInvalidated = true; _wnInvalidated = true; }
		...
		double accuracy) const 
	{
		...
		const Vector3D treeRVec =
			Engine::max(treeP - treeBound.lowerCorner, treeBound.upperCorner - treeP);
