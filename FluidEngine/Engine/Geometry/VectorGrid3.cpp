...
namespace Engine
{
	...
	void VectorGrid3::resize(size_t resolutionX, size_t resolutionY, size_t resolutionZ,
	...
	void VectorGrid3::resize(double gridSpacingX, double gridSpacingY, double gridSpacingZ,
		double originX, double originY, double originZ) 
	{
