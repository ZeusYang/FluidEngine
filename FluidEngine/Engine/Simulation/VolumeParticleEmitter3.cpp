...
namespace Engine
{
	...
	VolumeParticleEmitter3::VolumeParticleEmitter3(
		...
		_allowOverlapping(allowOverlapping) { _pointsGen = std::make_shared<BccLatticePointGenerator>(); }
		...
		Array1<Vector3D>* newVelocities) 
	{
		...
		else 
		{
			...
			PointHashGridSearcher3 neighborSearcher(Size3(kDefaultHashGridResolution, kDefaultHashGridResolution,
