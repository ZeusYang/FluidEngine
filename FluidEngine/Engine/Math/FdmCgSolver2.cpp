...
namespace Engine
{
	...
	void FdmCgSolver2::clearUncompressedVectors() { _r.clear(); _d.clear(); _q.clear(); _s.clear(); }

	void FdmCgSolver2::clearCompressedVectors() { _rComp.clear(); _dComp.clear(); _qComp.clear(); _sComp.clear(); }
