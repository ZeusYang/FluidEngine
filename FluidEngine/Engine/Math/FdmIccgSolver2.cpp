...
namespace Engine
{
	void FdmIccgSolver2::Preconditioner::build(const FdmMatrix2& matrix)
	{
		...
		{
			double denom = matrix(i, j).center -
	...
	void FdmIccgSolver2::clearUncompressedVectors() { _r.clear(); _d.clear(); _q.clear(); _s.clear(); }

	void FdmIccgSolver2::clearCompressedVectors() { _r.clear(); _d.clear(); _q.clear(); _s.clear(); }
